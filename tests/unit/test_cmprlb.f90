...
contains
   ...
   subroutine case_unconstrained_with_history()
      ...
      integer  :: index(n), col, head, nfree, info
      ...
      call assert_eq_int(info, 0, where="case_unconstrained_with_history info")
   ...
   subroutine case_constrained_no_history()
      ...
      call assert_eq_int(info, 0, where="case_constrained_no_history info")
   ...
   subroutine case_constrained_zero_step()
      ...
      call assert_eq_int(info, 0, where="case_constrained_zero_step info")
   ...
   subroutine case_constrained_nontrivial_step()
      ...
      call assert_eq_int(info, 0, where="case_constrained_nontrivial_step info")
